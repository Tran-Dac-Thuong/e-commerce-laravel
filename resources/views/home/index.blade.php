                  ...
                  <div class="row">
                     <div class="col-md-7 col-lg-6 ">
                        <div class="detail-box">
                           ...
                           <div class="btn-box">
                              <a href="{{route('productPage')}}" class="btn1">
                              Shop Now
                              </a>
                           </div>
                        </div>
                     ...
                     <div class="col-md-6 offset-md-3">
                        <div class="subscribe_form ">
                           ...
                           <form action="{{route('discount_offer')}}" method="POST">
                              @csrf 
                              <input type="email" id="discount_input" name="email" onkeyup="Discount()" class="discount_input" placeholder="Enter your email">
                              <span class="dis_error" id="dis_error"></span>
                              <button type="submit" onclick="return Subscribe()" class="btn-sub">
                              subscribe
                              </button>
                           </form>
                        </div>
                              ...
                              <form action="{{route('discount_offer')}}" method="POST">
                                 ...
                                 <fieldset>
                                    <div class="field footer_dis_group">
                                       <input class="footer_input" type="email" name="email" id="discount_input_2" onkeyup="Discount2()" placeholder="Enter Your Mail" name="email" />
