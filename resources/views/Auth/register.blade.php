   ...
   <head>
      ...
      <style>
        ...
        form input{
         ...
         .form-group.invalid .input_register {
            border-color: #f7444e;
         }
      ...
      <div class="hero_area">
         ...
         <div class="container">
            <div class="card card-login">
                ...
                <div class="card-body">
                    <form action="{{route('postRegister')}}" id="form-register" method="POST">
                        @csrf
                        <div class="form-group">
                            <label for="">Name</label>
                            <input type="text" class="form-control input_register" id="name" name="name" placeholder="Enter name...">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input_register" id="email" name="email" placeholder="Enter email...">
                            <span class="form-message"></span>
                            @if ($errors->has('email'))
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" id="pass" class="form-control input_register" id="pass" name="password" placeholder="Enter password...">
                            <span class="form-message"></span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" id="cpass" class="form-control input_register" id="cpass" name="cpassword" placeholder="Please confirm your password...">
                            <span class="form-message"></span>
                        ...
                        <br>
                        <div class="form-group">
                            <input type="submit" class="btn btn-primary col-12 btn-login" value="Sign up">
                        </div>
                        <div class="form-group text-center">
                            Already a member?<a href="{{route('login')}}">Sign in now</a>
                        </div>
                    </form>
         ...
         document.addEventListener("DOMContentLoaded", function () {
           ...
           Validator({
             ...
             rules: [
               ...
               Validator.minLength("#pass", 8, "Password is required"),
               Validator.isRequired("#cpass"),
               Validator.isConfirmed(
                 "#cpass",
                 function () {
                   return document.querySelector("#form-register #pass").value;
                 },
             ...
             onSubmit: function (data) {
               ...
               window.location.href = "{{route('postRegister')}}";
               console.log(data);
             },
           });
         });
