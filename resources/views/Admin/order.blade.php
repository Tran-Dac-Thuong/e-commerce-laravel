                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if ($item->delivery_status == "processing")
                                        <a href="{{route('delivered', $item->id)}}"><button onclick="return confirm('Are you sure this product is delivered?')" class="btn btn-primary">Delivered</button></a>
                                    @else
                                      @if ($item->delivery_status == "Order canceled")
                                          <p>ORDER CANCELED</p>
                                      @else
                                        <p>DELIVERED</p>
                                      @endif
