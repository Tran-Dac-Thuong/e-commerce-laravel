    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
            ...
            <div class="profile-desc">
              <div class="profile-pic">
                ...
                <div class="profile-name">
                  <h5 class="mb-0 font-weight-normal">Thuong Tran</h5>
                  <span>Admin</span>
                </div>
              </div>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" data-toggle="collapse" href="#" aria-expanded="true" aria-controls="ui-basic">
              <span class="menu-icon">
            ...
            <div class="content-wrapper">
                ...
                <div class="container">
                  ...
                  <div class="category-title">
                    ...
                    <table class="table tb-category text-center">
                      <thead>
                        <tr>
                          <th>Category name</th>
                          <th>Action</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="action-group">
                                    ...
                                    <a href="{{route('deleteCategory', $item->id)}}"><button class="btn btn-danger" onclick="return confirm('Are you sure want to delete this category?')">Delete</button></a>
                                </td>
                            </tr>
                            @endforeach
